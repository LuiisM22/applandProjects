...
state={
 ...
 /*  componentDidMount(){
   setTimeout(()=>{
     this.setState({
       img:'https://firebasestorage.googleapis.com/v0/b/applandproyects.appspot.com/o/src%2Fimg%2Fjonathan.jpg?alt=media&token=893eea25-2446-44dd-9df2-ff894e57a8f'
     })
   },5000) 
  } */
  render(){
    const {title, autor, category, description, qualification, img}=this.props
    return(
      <div className="max-w-sm w-full lg:max-w-full lg:flex">
        ...
        <div className="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
          <div >
            ...
            <p className="text-gray-700 text-base leading-none">Autor: {autor}</p>
